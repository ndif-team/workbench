import {
    ...
    workshopAnnotations as sqliteWorkshopAnnotations,
} from "./schema.sqlite";
import {
    ...
    workshopAnnotations as pgWorkshopAnnotations,
} from "./schema.pg";
...
export const workshopAnnotations = isLocal ? sqliteWorkshopAnnotations : pgWorkshopAnnotations;
