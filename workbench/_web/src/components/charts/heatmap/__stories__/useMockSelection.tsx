...
import { useHeatmapView } from "./MockViewProvider";

/**
 * Mock version of useSelection for Storybook
 * Uses mock providers instead of real backend
 */
export const useMockSelection = () => {
    const {
        filteredData: data,
        xStep,
        bounds,
        ...
        (e: React.MouseEvent<HTMLDivElement>) => {
            ...
            const onUp = () => {
                ...
                if (final) {
                    ...
                    setActiveSelection(normalizedBounds);
                    persistView({
                        xStep: xStep,
    ...
    const zoomIntoActiveSelection = useCallback(async () => {
        ...
        // Clear only the transient selection
        setActiveSelection(null);
...
// Also export as useSelection for compatibility
export const useSelection = useMockSelection;
