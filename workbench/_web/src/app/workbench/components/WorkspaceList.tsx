  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          border: isDark ? '1px solid rgba(148, 163, 184, 0.4)' : '1px solid rgba(100, 116, 139, 0.5)', // slate-400 dark, slate-500 light (darker)
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-start justify-between gap-2">
            <h3 
              ...
              style={{ color: isHovered ? (isDark ? '#cbd5e1' : '#334155') : 'inherit' }}
            >
              {workspace.name}
            </h3>
            <Button
    ...
    <>
      ...
      {!workspaces || workspaces.length === 0 ? (
        <div className="text-center py-12 border-2 border-dashed rounded-lg">
          <p className="text-muted-foreground mb-2 text-lg font-medium">No workspaces found</p>
