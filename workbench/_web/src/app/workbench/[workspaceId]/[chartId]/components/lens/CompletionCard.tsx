          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom">
              <p className="w-36 text-wrap text-center">
                The displayed tokenization does not match the selected model. Please retokenize.
              </p>
            </TooltipContent>
          </Tooltip>
        )}
              ...
              <div className="flex items-center p-1 h-8 bg-background rounded flex-shrink-0">
                <button
                  ...
                  className={cn(
                    ...
                    ((chartType === "heatmap" && !isCreatingLineChart) || isCreatingHeatmap) &&
                      "bg-popover border",
                  )}
                >
                  {isCreatingHeatmap ? (
                ...
                <button
                  ...
                  className={cn(
                    "relative overflow-hidden flex items-center gap-2 px-3 py-0.5 rounded text-xs bg-transparent",
                    ((chartType === "line" && !isCreatingHeatmap) || isCreatingLineChart) &&
                      "bg-popover border",
                  )}
                >
                  {isCreatingLineChart ? (
