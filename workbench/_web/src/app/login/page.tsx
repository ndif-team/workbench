      ...
      <div className="w-full max-w-md">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Choose how you'd like to access the workbench</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-4">
              ...
              <Button onClick={handleGoogleLogin} className="w-full" variant="outline" disabled>
              ...
              <div className="space-y-3">
                {!showCaptcha ? (
                  <Button onClick={handleShowCaptcha} className="w-full" variant="outline">
